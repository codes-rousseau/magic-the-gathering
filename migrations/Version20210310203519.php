 ...
 */
final class Version20210310203519 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE card (id INT AUTO_INCREMENT NOT NULL, set_id INT NOT NULL, type_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, image_url VARCHAR(255) NOT NULL, artist VARCHAR(100) DEFAULT NULL, description LONGTEXT NOT NULL, uuid VARCHAR(100) NOT NULL, INDEX IDX_161498D310FB0D18 (set_id), INDEX IDX_161498D3C54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
