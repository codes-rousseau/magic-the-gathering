 ...
 */
final class Version20220302110615 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE card_id_seq1 CASCADE');
        ...
        $this->addSql('DROP SEQUENCE card_collection_id_seq1 CASCADE');
        ...
        $this->addSql('DROP TABLE pointcloud_formats');
        ...
        $this->addSql('ALTER TABLE card ALTER name SET NOT NULL');
        ...
        $this->addSql('ALTER TABLE card ALTER target SET NOT NULL');
        $this->addSql('ALTER TABLE card_collection ALTER published_at SET NOT NULL');
        $this->addSql('ALTER TABLE card_collection ALTER name SET NOT NULL');
        $this->addSql('ALTER TABLE card_collection ALTER svg SET NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE card_id_seq1 INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE SEQUENCE card_collection_id_seq1 INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE INDEX idx_tiger_state_the_geom_gist ON tiger.state (the_geom)');
        ...
        $this->addSql('CREATE INDEX tiger_place_the_geom_gist ON tiger.place (the_geom)');
        $this->addSql('CREATE TABLE pointcloud_formats (pcid INT NOT NULL, srid INT DEFAULT NULL, schema TEXT DEFAULT NULL, PRIMARY KEY(pcid))');
        ...
        $this->addSql('CREATE INDEX tige_cousub_the_geom_gist ON tiger.cousub (the_geom)');
        ...
        $this->addSql('CREATE INDEX idx_tiger_edges_the_geom_gist ON tiger.edges (the_geom)');
        ...
        $this->addSql('CREATE INDEX idx_addrfeat_geom_gist ON tiger.addrfeat (the_geom)');
        ...
        $this->addSql('CREATE INDEX tiger_faces_the_geom_gist ON tiger.faces (the_geom)');
        ...
        $this->addSql('ALTER TABLE card_collection ALTER published_at DROP NOT NULL');
        $this->addSql('ALTER TABLE card_collection ALTER name DROP NOT NULL');
        $this->addSql('ALTER TABLE card_collection ALTER svg DROP NOT NULL');
        $this->addSql('ALTER TABLE card ALTER name DROP NOT NULL');
        ...
        $this->addSql('ALTER TABLE card ALTER description TYPE VARCHAR(5000)');
        $this->addSql('ALTER TABLE card ALTER artist DROP NOT NULL');
        $this->addSql('ALTER TABLE card ALTER target DROP NOT NULL');
    }
}
