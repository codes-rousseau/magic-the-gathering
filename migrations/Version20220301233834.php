 ...
 */
final class Version20220301233834 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE card_collection ALTER id DROP DEFAULT');
        $this->addSql('ALTER TABLE card_collection ALTER published_at TYPE DATE');
        $this->addSql('ALTER TABLE card_collection ALTER published_at DROP DEFAULT');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE card_collection_id_seq');
        $this->addSql('SELECT setval(\'card_collection_id_seq\', (SELECT MAX(id) FROM card_collection))');
        $this->addSql('ALTER TABLE card_collection ALTER id SET DEFAULT nextval(\'card_collection_id_seq\')');
        $this->addSql('ALTER TABLE card_collection ALTER published_at TYPE TIMESTAMP(0) WITHOUT TIME ZONE');
        $this->addSql('ALTER TABLE card_collection ALTER published_at DROP DEFAULT');
