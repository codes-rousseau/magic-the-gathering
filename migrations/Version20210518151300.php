 ...
 */
final class Version20210518151300 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE collection_card (id INT NOT NULL, code VARCHAR(6) NOT NULL, name VARCHAR(255) NOT NULL, card_count INT NOT NULL, search_uri VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
